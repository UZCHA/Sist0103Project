		...
		<table class="table table-bordered" style="width: 550px;">
			...
			<tr>
				...
				<td colspan="4">
					<%
						for(int i=1;i<=10;i++)
						{
							//dto.getImage가 숫자가 아니라 string문자열이라 형변환 해줘야함
							int n=Integer.parseInt(dto.getImage());
						
						%>
							<input type="radio" value="<%=i%>"
							<%=i==n?"checked":"" %> style="width: 35px" name="image">
						<%}
					%>
					<br>
					<%
			...
			<tr>
				...
				<input type="hidden" name="num" value="<%=num%>">
					...
					style="width: 100px;">
					<input type="button" value="방명록" class="btn btn-outline-success"
					onclick="location.href='guestList.jsp'" style="width: 100px;">
				</td>
			</tr>
