...
<div style="margin: 100px 100px; width: 400px;">
	...
	<input type="hidden" name="num" value="<%=num%>">
		<table class="table table-bordered">
			...
			<tr>
				<th width="100" class="table-info">혈핵형</th>
				<td>
			...
			<tr>
				...
				<td class="d-inline-flex">
					<select name="hp1" class="form-control" style="width: 100px;">
						<% 
							String[] strHp={"010","011","019","018"};
					...
					<b>-</b>
					<input type="text" name="hp2" required="required" class="form-control" 
					style="width: 100px;" onkeyup="goFocus(this)" value="<%=hp2%>">
					<b>-</b>
					<input type="text" name="hp3" required="required" 
					class="form-control" style="width: 100px;" value="<%=hp3%>">
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="date" name="birth" required="required" class="form-control"
					style="width:150px;" value=<%=dto.getBirth()%>> 
				</td>
			</tr>
