...
<div style="margin: 100px 100px; width: 600px;">
	<table class="table table-bordered">
		<caption align="top"><b>전체내용보기</b></caption>
		<tr>
			<td>
				<b style="font-size: 1.5em;">${dto.subject }</b>
				<span style="color: #ccc;float: right;font-size: 0.9em;">
		...
		<tr>
			<td>작성자: ${dto.writer }<span style="float: right;color: #ccc;">조회: ${dto.readcount }</span>
				<div>
		...
		<tr>
			<td>
				...
				<br>
				<c:if test="${dto.photo!='no' }">
					<c:forTokens var="img" items="${dto.photo }" delims=",">
						<img alt="" src="../photo/${img }" style="width: 100px;"
						class="img-thumbnail">&nbsp;&nbsp;
					</c:forTokens>
				</c:if>
			</td>
