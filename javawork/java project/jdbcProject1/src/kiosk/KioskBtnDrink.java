...
public class KioskBtnDrink extends JFrame implements ActionListener{
	Container cp;
	JButton btn1, btn2;
	...
	public KioskBtnDrink(String title) {
		super(title);
	...
	public void tableWrite() {
		...
		String sql="select *from kiosk_drinkmenu";
	...
	/*public static void main(String[] args) {
		...
		KioskBtnDrink drink=new KioskBtnDrink("음료 메뉴");
	}*/
