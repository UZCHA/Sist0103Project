...
public class KioskBtnBurger extends JFrame implements ActionListener{
	Container cp;
	JButton btn1, btn2;
	...
	public KioskBtnBurger(String title) {
		super(title);
	...
	public void tableWrite() {
		...
		/*public void insertData(String num)
		{
			...
			String sql="INSERT INTO kiosk_menu2(num, name, price, su, tot) " +
					"SELECT num, name, price, su, tot FROM kiosk_menu WHERE num = ?";
		...
		KioskBtnBurger burger=new KioskBtnBurger("햄버거메뉴");
	}*/
		@Override
