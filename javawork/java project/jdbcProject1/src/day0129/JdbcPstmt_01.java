...
public class JdbcPstmt_01 {
	...
	//update 수정 num을 인자로 받아서 데이타가 있으면 true 없으면 false를 반환하는 메서드
	...
	public void updateSangpum()
	{
		...
		//여기에서 isonedata호출해서 그 번호가 존재하는지 확인해야함
