		...
		<caption align="top">상품정보</caption>
			<tr>
				...
				<td>
					...
					style="width: 150px;" required="required"  value="${dto.sangname }">
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					style="width: 150px;" required="required"  value="${dto.sangprice }">
				</td>
			</tr>
			<tr>
				<th>색상</th>
				<td>
					...
					style="width: 150px;" required="required"  value="${dto.sangcolor }">
				</td>
			</tr>
			<tr>
				<th>입고일</th>
				<td>
					...
					style="width: 150px;" required="required"  value="${dto.sangipgo }">
				</td>
			</tr>
			<tr>
