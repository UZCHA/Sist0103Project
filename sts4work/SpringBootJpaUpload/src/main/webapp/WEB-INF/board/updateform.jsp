...
<div style="margin: 100px 100px; width: 500px;">
	...
	<input type="hidden" name="num" value="${dto.num }">
		<table class="table table-bordered">
			<tr>
				<th class="table-warning" width="150">작성자</th>
				<td>
					${dto.writer }
				</td>
			</tr>
			<tr>
				<th class="table-warning" width="150">제목</th>
				<td>
					<input type="text" name="writer" required="required"
					class="form-control" style="width: 150px;" value="${dto.subject }">
				</td>
			</tr>
			<tr>
				<th class="table-warning" width="150">사진</th>
				<td>
